          ...
          <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
            <FadeLeft>
              <Box sx={{ maxWidth: 700 }}>
                ...
                >
                  Construimos el <span className="gradient-text-cyan">futuro</span> de las pymes
                </Typography>
                <Typography
                  variant="body1"
                  sx={{
            ...
            >
              <FadeLeft>
                <Box>
                  ...
                  >
                    Control nació para cambiar eso. Creemos que una papelería de barrio merece las
                    mismas herramientas que una cadena de supermercados — adaptadas a su escala, sin
                    las complejidades ni el precio exorbitante.
                  </Typography>
                </Box>
              </FadeLeft>
                    ...
                    {i % 2 === 0 && (
                      <FadeLeft>
                        ...
                        >
                          ...
                          <Typography
                            variant="body2"
                            sx={{ color: BRAND.textSecondary, lineHeight: 1.7 }}
                          >
