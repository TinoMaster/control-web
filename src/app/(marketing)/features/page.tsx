      ...
      >
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ maxWidth: 680 }}>
            ...
            >
              Todo en una sola{' '}
              <span className="gradient-text-cyan">aplicación</span>
            </Typography>
            <Typography
              variant="body1"
              sx={{
            ...
            >
              Control integra más de 12 módulos para operar tu negocio de manera
              profesional, sin necesidad de múltiples aplicaciones.
            </Typography>
            <Button
              variant="contained"
              size="large"
      ...
      <Box sx={{ py: { xs: 8, md: 10 }, textAlign: 'center' }}>
        <Container maxWidth="sm">
          ...
          <Typography variant="body1" sx={{ color: BRAND.textSecondary, mb: 4, lineHeight: 1.7 }}>
            30 días de acceso completo a todas las características. Sin tarjeta de crédito requerida.
          </Typography>
