    ...
    >
      ...
      <Container maxWidth="lg" sx={{ position: "relative", zIndex: 1 }}>
        ...
        >
          ...
          >
            Todo lo que necesita <span className="gradient-text-cyan">tu negocio</span>
          </Typography>
          <Typography
            variant="body1"
            sx={{ color: BRAND.textSecondary, lineHeight: 1.75, maxWidth: 520 }}
          >
            Herramientas diseñadas específicamente para pymes y negocios en crecimiento. Sin
            complicaciones, sin curva de aprendizaje.
          </Typography>
        </Box>
